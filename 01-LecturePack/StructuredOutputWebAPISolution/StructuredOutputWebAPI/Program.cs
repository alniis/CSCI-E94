...
namespace StructuredOutputWebAPI
{
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            */
            ...
            {
                // Add nice title
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Structured Output Web API Chat Demo", Version = "v1" });
            ...
            var _aiSettings = new AISettings();
            builder.Configuration.GetSection("AISettings").Bind(_aiSettings);
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Structured Output Chat Demo");
